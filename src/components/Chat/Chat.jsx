...
function Chat({ chat, setCurrentGroup }) {
  ...
  if (chat.from === username) {
    return (
      <div
        ...
        <span className={styles.myChatFrom}>
        ...
        <span className={styles.chatContent}>{chat.text}</span>
      </div>
    );
  }
  ...
  return (
    <div
      ...
      <span className={styles.otherChatFrom} onClick={handleFromClick}>
        <span className={styles.othername}>{chat.from}</span>
